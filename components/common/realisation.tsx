...
export function RealisationBandeau() {
    ...
    return (
        <div data-animate-type="motion-safe:animate-fadeInUp" className="js-show-on-scroll bg-grey-realisation text-realisation-title-size text-center pt-realisation-top pb-realisation-bottom">
                Nos Réalisations
