...
export default function Satisfaction(){
    ...
    return(
        <>    
            <div className="bg-general-grey flex flex-col gap-20 text-white text-center p-10 text-satisfaction-size">
                Notre credo : la satisfaction de nos clients
                <div className="px-[10%] text-corps-size text-start leading-loose">
                ...
                <div className='flex flex-wrap gap-20 px-4 items-center justify-center'>
                    ...
                    <div className='flex flex-col space-y-2'>
                        ...
                        <div className='flex flex-col space-y-2'>
                            <div className='flex flex-row space-x-4 items-center justify-center font-black'>
                                <CountUp end={30} duration={3} redraw={false}>
                                    {({ countUpRef, start }) => (
                                        <VisibilitySensor onChange={() => {triggerStart(start)}} delayedCall>
                                            <span ref={countUpRef} />
                                        </VisibilitySensor>
