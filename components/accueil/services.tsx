...
export function Services() {
    return (
        <div className="flex flex-col bg-white pb-[5%]">
            ...
            <div className=" text-service-corps px-[10%] space-x-[3%] text-center flex flex-col phone:flex-row">
                <div className="flex flex-col border-[1px] px-[2%] py-[3%] mt-[2%] border-[#E6E6E6] hover:shadow-2xl transition-all duration-[2000]">
                ...
                <div className="flex flex-col border-[1px] px-[2%] py-[3%] border-[#E6E6E6] hover:shadow-2xl transition-all duration-[2000]">
                ...
                <div className="flex flex-col border-[1px] px-[2%] py-[3%] mt-[2%] border-[#E6E6E6] hover:shadow-2xl transition-all duration-[2000]">
                    ...
                    <div className="uppercase text-service-title my-3 font-medium text-title-size">
                        Le SAV
                    </div>
                    <div className="leading-7 text-corps-size">
